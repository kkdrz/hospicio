...
<nav class="navbar navbar-dark indigo"><span class="navbar-brand">Hospic.io</span>
    <span class="navbar"  style="color:white;">Powrót</span>
</nav>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Na wybrany semestr istnieje już zaakceptowany plan hospitacji!</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">×</span></button>
            </div>
            <div class="modal-footer">
                <button type="button" onclick="$('#modal').hide();" class="btn btn-primary">OK</button>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="offset-md-1 col-md-10">
        <form class="form-inline">
            ...
            <a class="btn btn-danger pi-draggable"
               <c:if test="${!it.czyZaakceptowany()}">href="/plan/${it.id}/zatwierdz"</c:if> draggable="true">
